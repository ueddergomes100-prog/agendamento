...
export type Appointment={paymentStatus?:string;paymentId?:string;paidCents?:number;id:string;salon_id:string;unit_id:string;client_id:string;professional_id:string;service_id:string;service_name:string;professional_name:string;client_name:string;client_phone:string;starts_at:string;ends_at:string;status:string;hold_expires_at?:string;price_cents:number;deposit_cents:number;addons:Addon[];address:string;timezone:string;review?:{rating:number;comment:string}};
export type AccountType='CLIENT'|'SALON';
export type Profile={id:string;name:string;phone:string;birthday?:string;marketing:boolean;account_type?:AccountType};
export type Me={profile:Profile|null;account_type?:AccountType;memberships:{salon_id:string;role:string}[]};
